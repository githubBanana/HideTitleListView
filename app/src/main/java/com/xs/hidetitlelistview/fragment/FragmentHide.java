package com.xs.hidetitlelistview.fragment;
...
import com.xs.hidetitlelistview.MainActivity;
import com.xs.hidetitlelistview.R;

import java.util.ArrayList;
import java.util.HashMap;
import java.util.Map;

public class FragmentHide extends Fragment implements AnimatorListener {
    ...
    void initData() {
        ...
        SimpleAdapter adapter = new SimpleAdapter(getActivity(), mlistItems,
